            ...
            <div className="px-6 py-4 bg-[#111]/30 border-b border-[#1A1A1A] flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="p-2.5 bg-[#111] hover:bg-[#222] border border-[#222] text-[#8C8C8C] hover:text-cream rounded-xl transition-colors cursor-pointer"
                  title="Initialize Consult Video Call"
                >
              ...
              {isLoadingMessages ? (
                ...
                messages.map((msg, idx) => {
                  ...
                  return (
                    ...
                    >
                      <div 
                        className={`max-w-[70%] p-3.5 rounded-2xl border text-xs leading-relaxed shadow-lg ${
                          isOwnMessage 
